...
<div class="staff-grid">
  ...
  <div class="staff-card glass-surface slide-up">
    <img src="https://mc-heads.net/body/espiral_/100" class="staff-skin-img" alt="espiral_">
    <h3>espiral_</h3>
    <p class="rank team">DestinyTeam</p>
  </div>
  <div class="staff-card glass-surface slide-up">
    <img src="https://mc-heads.net/body/pilahd14/100" class="staff-skin-img" alt="pilahd14">
    <h3>pilahd14</h3>
    <p class="rank team">DestinyTeam</p>
  </div>
  <div class="staff-card glass-surface slide-up">
